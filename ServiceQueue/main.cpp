...
//  CS251-Project2
//
//  Created by Jazbel Lopez on 2/20/19.
//  Copyright © 2019 Jazbel Lopez. All rights reserved.
//

/*
    This program simulates buzzers at restaurants where the host can 
    seat the first person in line, add a buzzer to the end of the queue, 
    take a bribe which would move that buzzer to the front of the line and 
    lastly kick a buzzer out of line. Utilizing a doubly linked list will 
    allow you to easily take a buzzer id from the middle of the queue. 
    While a singly linked list is used to know the place of the buzzer id 
    in the queue. The purpose of this program is to learn the ins and outs of
    a linked list all while maintaining constant runtime.  
*/
